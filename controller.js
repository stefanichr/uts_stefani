...
exports.ubahT_level = function(req,res){
    ...
    function(error, rows, fields){
        ...
        //mengubah data berdasarkan id
    exports.ubahT_servis = function(req,res){
    var id = req.body.id_servis;
    var tanggal = req.body.tgl_servis;
    var id_user = req.body.id_user;
    var id_montir = req.body.id_montir;
    var jumlah_sparepart = req.body.jumlah_sparepart;
    var id_sparepart = req.body.id_sparepart;

    connection.query('UPDATE T_servis SET tgl_servis=?, id_user=?, id_montir=?, jumlah_sparepart=?, id_sparepart=? WHERE id_servis=?', [tanggal,id_user,id_montir,jumlah_sparepart,id_sparepart,id],
    function(error, rows, fields){
        if(error){
            console.log(error);
        }else{
    ...
    response.ok("Berhasil hapus Data!",res)
      ...
      exports.hapusT_sparepart= function(req,res){
        ...
        response.ok("Berhasil hapus Data!",res)
           ...
           //menghapus data berdasarkan id
      exports.hapusT_user= function(req,res){
        var id = req.body.id_user;
        connection.query('DELETE FROM T_user WHERE idT_user=?',[id],
        function(error, rows, fields){
        if(error){
        console.log(error);
        }else{
        response.ok("Berhasil hapus Data!",res)
           ...
           //menghapus data berdasarkan id
      exports.hapusT_level= function(req,res){
        var id = req.body.id_level;
